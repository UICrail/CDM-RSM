...
Use of non-superclass expression in position that requires a superclass expression: ObjectUnionOf(<https://cdm.ovh/rsm/localisation/localisation#LinearLocation> <https://cdm.ovh/rsm/topology/topology#LinearElement>) [SubClassOf(<https://cdm.ovh/rsm/adapters/geosparql_adapter/geo_ad#LinearThings> ObjectUnionOf(<https://cdm.ovh/rsm/localisation/localisation#LinearLocation> <https://cdm.ovh/rsm/topology/topology#LinearElement>)) in OntologyID(OntologyIRI(<https://cdm.ovh/rsm/adapters/geosparql_adapter/geo_ad>) VersionIRI(<https://cdm.ovh/rsm/adapters/geosparql_adapter/0.6/geo_ad>))]
